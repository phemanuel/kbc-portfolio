                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                  
                                                        <h5 class="mb-0 py-2">Update Project</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('update-user-portfolio', ['id' => $userPortfolios->id]) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf	
                                                        @method('PUT')													
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Project Name</span></label>
                                                                    <input type="text" class="form-control" name="file_name" placeholder="Lotan Cover Design" value="{{$userPortfolios->file_name}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Project Description</span></label>
                                                                    <input type="text" class="form-control" name="file_description" placeholder="Lotan Cover Design" value="{{$userPortfolios->file_description}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Project File Type</span></label>
                                                                    <select name="file_type" class="form-control">
                                                                        <option value="{{$userPortfolios->file_type}}">{{$userPortfolios->file_type}}</option>
