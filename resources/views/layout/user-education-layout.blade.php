...
<li><a href="{{ route('user-service') }}" aria-expanded="false"><i class="nav-icon ti ti-layout-grid4-alt"></i><span class="nav-title">Services</span></a> </li>
                            <li class="active"><a href="{{ route('user-education') }}" aria-expanded="false"><i class="nav-icon ti ti-layout"></i><span class="nav-title">Education/Certification</span></a> </li>
                                    ...
                                    <div class="ml-auto d-flex align-items-center">
                                        <nav>
                                            <ol class="breadcrumb p-0 m-b-0">
                                                ...
                                                <li class="breadcrumb-item active text-primary" aria-current="page"><a href="#">Education</a></li>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                  
                                                        <h5 class="mb-0 py-2">Add Education and Professional Certification</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('user-education-save') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf														
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">College/Institution</span></label>
                                                                    <input type="text" class="form-control" name="college_name" placeholder="Crescent University"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Qualification</span></label>
                                                                    <input type="text" class="form-control" name="college_qualification" placeholder="Bsc Computer Science"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Year</span></label>
                                                                    <input type="text" class="form-control" name="college_year" placeholder="2010"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Certificate(pdf format only) - <span class="style3">Optional</span></span></label>
                                                                    <input type="file" name="college_certificate"  class="form-control" style="color: black;"/>
                                                                </div>
                                                          </div>      
                                                          <input type="hidden" name="user_id" value="{{auth()->user()->id}}">                                                                                                  
                                                            <button type="submit" class="btn btn-primary">Add Education/Certification</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 border-t col-12">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif 
                                                   <h5 class="mb-0 py-2">Education/Certification History</h5>
                                                    </div>
                                                    <div class="p-4">
                                                        ...
                                                        @else
                                                            <table class="table">                                                            
                                                                ...
                                                                <tbody>
                                                                    @foreach($userEducations as $index => $userEducation)
                                                                    <tr>                                                                   
                                                                        <td width="5%">
                                                                    ...
                                                                    @endif                                                                
                                                                        ...
                                                                        <td width="30%">
                                                                            <p class="style2">{{ $userEducation->college_name }}</p>
                                                                            <p class="style2">{{ $userEducation->college_qualification }}</p>
                                                                            <p class="style2">{{ $userEducation->college_year }}</p>                                                                      </td>                                                                        
                                                                        <td width="5%">
                                                                            <a href="{{ route('edit-user-education', ['id' => $userEducation->id]) }}" class="btn btn-icon btn-xs btn-success" data-placement="top" title="Edit"><i class="dripicons dripicons-document-edit"></i></a>
                                                                            <a href="{{ route('delete-user-education', ['id' => $userEducation->id]) }}" class="btn btn-icon btn-xs btn-danger" data-placement="top" title="Remove"><i class="dashicons dashicons-trash"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                    @endforeach
                                                                </tbody>
