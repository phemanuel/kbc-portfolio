                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                  
                                                        <h5 class="mb-0 py-2">Edit your skill and proficiency.</h5>
                                                    </div>
                                                    <div class="p-4">
                                                        <form name="asic-form" action="{{ route('update-user-skill', ['id' => $userSkill->id]) }}" method="POST">
                                                        @csrf		
                                                        @method('PUT')												
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Skill</span></label>
                                                                    <input type="text" class="form-control" name="user_skill" value="{{ $userSkill->user_skill }}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Proficiency(%)</span></label>
                                                                    <input type="text" class="form-control" name="user_skill_level" value="{{ $userSkill->user_skill_level }}"  style="color: black;">
                                                                </div>
                                                          </div>                                                                                       
