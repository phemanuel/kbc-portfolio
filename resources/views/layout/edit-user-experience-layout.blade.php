                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                 
                                                        <h5 class="mb-0 py-2">Edit Work Experience</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('update-user-experience', ['id' => $userExperiences->id]) }}" method="POST">
                                                        @csrf	
                                                        @method('PUT')													
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Company</span></label>
                                                                    <input type="text" class="form-control" name="user_company" placeholder="Lotan Consult" value="{{ $userExperiences->user_company }}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Role</span></label>
                                                                    <input type="text" class="form-control" name="user_company_role" placeholder="Software Developer" value="{{ $userExperiences->user_company_role }}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Year</span></label>
                                                                    <input type="text" class="form-control" name="company_year" placeholder="2010" value="{{ $userExperiences->company_year }}"  style="color: black;">
                                                                </div>                                                               
                                                                <div class="form-group">
                                                                <label for="add1"><span class="style1">Tell us about the role (80 words)</span></label>
                                                                <textarea id="editor1" rows="5" style="border: 1px solid #cbd5e0; width: 100%" maxlength="80" name="user_about_role" placeholder="Start typing...." autofocus>{{ $userExperiences->user_about_role }}</textarea>
