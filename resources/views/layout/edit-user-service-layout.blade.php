                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                 
                                                        <h5 class="mb-0 py-2">Update Service</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('update-user-service', ['id' => $userServices->id]) }}" method="POST">
                                                        @csrf	
                                                        @method('PUT')													
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Name of Service</span></label>
                                                                    <input type="text" class="form-control" name="user_service" placeholder="Content Writing" value="{{ $userServices->user_service }}"   style="color: black;">
                                                                </div>                                                                                                                              
                                                                <div class="form-group">
                                                                <label for="add1"><span class="style1">Describe the service (30 words)</span></label>
                                                                <textarea id="editor1" rows="5" style="border: 1px solid #cbd5e0; width: 100%" maxlength="30" name="user_service_description" placeholder="Start typing...." autofocus>
                                                                {{ $userServices->user_service_description }}</textarea>
