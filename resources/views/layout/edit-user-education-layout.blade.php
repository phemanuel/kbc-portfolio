                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif                                                  
                                                        <h5 class="mb-0 py-2">Update Education and Professional Certification</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('update-user-education', ['id' => $userEducations->id]) }}" method="POST" enctype="multipart/form-data">
                                                        @csrf	
                                                        @method('PUT')													
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">College/Institution</span></label>
                                                                    <input type="text" class="form-control" name="college_name" placeholder="Crescent University" value="{{$userEducations->college_name}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Qualification</span></label>
                                                                    <input type="text" class="form-control" name="college_qualification" placeholder="Bsc Computer Science" value="{{$userEducations->college_qualification}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Year</span></label>
                                                                    <input type="text" class="form-control" name="college_year" placeholder="2010" value="{{$userEducations->college_year}}"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Certificate(pdf format only) - <span class="style3">Optional</span></span></label>
                                                                    <input type="file" name="college_certificate"  class="form-control" />
                                                                </div>
                                                          </div>      
                                                          <input type="hidden" name="user_certificate_file" value="{{$userEducations->college_certificate}}">                                                                                                  
                                                            <button type="submit" class="btn btn-primary">Update Education/Certification</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
