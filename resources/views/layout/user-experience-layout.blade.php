                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-xl-5 col-md-6 col-12 border-t border-right">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif 
                                                    @if ($errors->has('user_about_role'))
                                                    <div class="alert alert-danger">
                                                        {{ $errors->first('user_about_role') }}
                                                    </div>
                                                    @endif                                                 
                                                        <h5 class="mb-0 py-2">Add Work Experience</h5>
                                                    </div>
                                                    <div class="p-4">
                                                    <form name="asic-form" action="{{ route('user-experience-save') }}" method="POST">
                                                        @csrf														
                                                        <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Company</span></label>
                                                                    <input type="text" class="form-control" name="user_company" placeholder="Lotan Consult"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Role</span></label>
                                                                    <input type="text" class="form-control" name="user_company_role" placeholder="Software Developer"  style="color: black;">
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="name1"><span class="style1">Year</span></label>
                                                                    <input type="text" class="form-control" name="company_year" placeholder="2010"  style="color: black;">
                                                                </div>                                                                
                                                                <div class="form-group">
                                                                <label for="add1"><span class="style1">Tell us about the role (50 words)</span></label>
                                                                <textarea id="editor1" rows="5" style="border: 1px solid #cbd5e0; width: 100%" maxlength="80" name="user_about_role" placeholder="Start typing...." autofocus></textarea>
                                            ...
                                            <div class="col-xl-4 col-md-6 border-t col-12">
                                                <div class="page-account-form">
                                                    ...
                                                    @endif 
                                                   <h5 class="mb-0 py-2">Work Experience History</h5>
                                                    </div>
                                                    <div class="p-4">
                                                        <!-- display education history -->
                                                        <form>
                                                        @if ($userExperiences->isEmpty())
                                                            <p class="style1">No work experience have been uploaded yet.</p>
                                                        @else
                                                        <div class="table-container">
    <table class="table" width="100%" border="0" cellpadding="3" cellspacing="3">
        <thead>
            <tr>
                <th width="80%"><span class="style2">Company</span></th>
                <th width="20%"><span class="style1">Actions</span></th>
            </tr>
        </thead>
        <tbody>
            @foreach($userExperiences as $index => $userExperience)
            <tr>
                <td>
                    <p class="style2">{{ $userExperience->user_company }}</p>
                    <p class="style2">{{ $userExperience->company_year }}</p>
                    <p class="style2"><p class="style2">{{ $userExperience->user_company_role }}</p>
                </td>
                
                <td>
                    <a href="{{ route('edit-user-experience', ['id' => $userExperience->id]) }}" class="btn btn-icon btn-xs btn-success" data-placement="top" title="Edit"><i class="dripicons dripicons-document-edit"></i></a>
                    <a href="{{ route('delete-user-experience', ['id' => $userExperience->id]) }}" class="btn btn-icon btn-xs btn-danger" data-placement="top" title="Remove"><i class="dashicons dashicons-trash"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
    </table>
    {{$userExperiences->links()}}
</div>
